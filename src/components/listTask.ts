...
<span class="text-text-secondary text-md">چه کارهایی امروز برای انجام داری؟</span>
<span class="text-text-muted text-sm">میتونی الان تسک‌هاتو اینجا بنویسی و برنامه ریزی رو شروع کنی!</span></div>
</div>
`;
