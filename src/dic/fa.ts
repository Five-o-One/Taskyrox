export const FaDic = {
  ...
  navbarDarkThemeTitle: 'تاریک',
  
  navbarPageTitle: 'صفحه',
  navbarPageStatus: 'در حال ساخت است',
  navbarPageDescription:
  'این صفحه در حال طراحی و توسعه است.\nبه‌زودی امکانات این بخش در دسترس شما قرار خواهد گرفت.',
}
